/* ---- This handles submitting the subscribe form to my api server ---- */
...
window.onload = function () {
    var _screen = document.getElementById('tester'); // This is only for testing, replace/remove
